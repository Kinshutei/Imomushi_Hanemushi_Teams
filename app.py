...
def main():
    ...
    st.markdown("""
    <style>
    [data-testid="stTabs"] > div:first-child { display: flex !important; justify-content: center !important; }
    [data-testid="stTabs"] button { display: flex; align-items: center; gap: 6px; }
